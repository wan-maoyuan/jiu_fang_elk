...
EOF
  ...
  openssl pkcs12 -in /etc/elasticsearch/config/certs/elastic-certificates.p12 -clcerts -nokeys -password pass:'123456' > /etc/elasticsearch/config/certs/client.cer
